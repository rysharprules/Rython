...
- [Libraries and the Flask web framework](#libraries-and-the-flask-web-framework)
  ...
  - [Flask Framework](#flask-framework)
    - [Routing](#routing)
- [Code to fetch all books from the database and return their details.](#code-to-fetch-all-books-from-the-database-and-return-their-details)
- [Code to fetch the book entry with matching id from the database and](#code-to-fetch-the-book-entry-with-matching-id-from-the-database-and)
- [Code to create a new book entry in the database.](#code-to-create-a-new-book-entry-in-the-database)
...
2. **Trigger an action**: for example, to view existing data, add or delete data, or search for results via **request routing**. Request routing allows the web app to match those requests to associated actions and triggers the relevant app code.
